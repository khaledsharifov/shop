...
export default function Product() {
  ...
  return (
    <div>
      ...
      <div className="">
        <div className="">
          <div className="my-[50px] flex items-start bg-[#fff] p-[20px] rounded-[20px]">
            <div className="w-[70%] ">
              <img
                src={product?.img}
                alt=""
                ...
                <Box sx={{ width: "100%", typography: "body1" }}>
                  <TabContext value={value}>
                    ...
                    <TabPanel value="2" className="border">
                      <div>
                        <p>
                          Доставка по Таджикистану осуществляется в течении 1-2
                          рабочих дней в зависимости от Вашего города или
                          района.{" "}
                        </p>
                        <p className="py-4">
                        ...
                        <p className="py-4">
                          Доставка осуществляется в течении рабочего дня начиная
                          с 13:00 до 18:00 каждый день, без выходных.{" "}
                        </p>
                        <p className="text-[#ff4d00] pt-4">* Примечание:</p>
                        <p className="py-4">
                          {" "}
                          Срок доставки некоторых товаров может достигать до 7-8
                          дней и зависит от категории товара. Наши консультанты
                          Вас проинформируют во время подтверждения Вашего
                          заказа по телефону.
                        </p>
                        ...
                        <p className="pt-8">
                          Более подробную информацию о доставке до Вашего адреса
                          можете получить позвонив по номеру +992929790059 или
                          написав на один из мессенджеров (
